...
class _LoginScreenState extends ConsumerState<LoginScreen>
  ...
  Future<void> _submit() async {
    ...
    if (state.hasError) {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
          content: Text(_loginErrorMessage(state.error)),
      ...
      if (!mounted) return;
      context.go(_homeFor(profile));
    }
  }

  String _homeFor(UserModel? profile) {
    return profile?.isManager == true ? '/manager/approvals' : '/dashboard';
  }
  ...
  String _loginErrorMessage(Object? error) {
    ...
    if (message.contains('invalid_credentials') ||
      ...
      return 'Email hoặc mật khẩu không đúng. Tài khoản phải tồn tại trong '
          'Supabase Authentication, không chỉ trong bảng users.';
    }
